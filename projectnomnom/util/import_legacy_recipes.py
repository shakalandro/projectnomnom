'''
This script will transform legacy recipes from the projectnomnom V1.0 system. Takes the legacy
XML recipe data and puts it into a JSON format that django can use to seed its database.

CAUTION: Assigns incremental recipe ids (starting with 1). Be careful if adding to a non-empty
        database.
...
if __name__ == '__main__':    
    ...
    f = open(os.path.join(os.path.dirname(__file__), '../fixtures/initial_data.json'), 'w')
